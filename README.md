...
- 💼 Wallet Info - Показать информацию о кошельке
- 💰 Deposit QR code - Сгенерировать QR код для пополнения
- 💳 Balance - Проверить баланс
- ▶️ Start - Запустить бота
- 💸 Withdraw - Вывести средства
- ⚙️ Settings - Настройки бота
- 🔄 Create New MevBot Wallet - Создать новый кошелек
- 🔑 Import Wallet - Импортировать существующий кошелек
- 🚪 Exit - Выход

### Важные замечания

- Для работы бота требуется минимальный баланс 3 SOL
- Рекомендуемый начальный баланс: 5-10 SOL
- Все операции с адресами производятся через защищенный API сервер
- QR код для пополнения генерируется с актуальным адресом из API

### Безопасность

- Храните свой приватный ключ в безопасном месте
- Не передавайте приватный ключ третьим лицам
- Регулярно проверяйте баланс кошелька
- Используйте надежные пароли для защиты кошелька
